package com.example.fa_malsha_c0871063_android.helper;
...
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    protected class SwipeUnderlayButton {
         ...
         */
        public SwipeUnderlayButton(Context context, String text, int imageResId, int textSize, int color, SwipeDirection swipeDirection, SwipeUnderlayButtonClickListener listener) {
